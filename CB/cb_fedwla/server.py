"""Federated Server Module for CatBoost."""
...
def server_fn(context: Context):
    ...
    # Initial global parameters aligned with the paper specifically for CatBoost
    initial_ndarray = np.array([
        rng.integers(20, 101),                  # iterations
        rng.integers(4, 9),                     # depth
        round(float(rng.uniform(0.05, 0.30)), 4)# learning_rate
    ], dtype=np.float32)
