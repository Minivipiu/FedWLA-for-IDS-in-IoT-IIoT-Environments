"""FedWLA Custom Aggregation Strategy Module for Random Forest."""
...
class FedWLA(FedAvg):
    ...
    def aggregate_fit(
        ...
        # Clamp and format specific Random Forest hyperparameters (all integers)
        ...
        aggregated_params[0][2] = max(2, int(np.round(aggregated_params[0][2])))
        aggregated_params[0][3] = max(1, int(np.round(aggregated_params[0][3])))
